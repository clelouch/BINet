...
if __name__ == '__main__':
    ...
    # Train data
    parser.add_argument('--train_root', type=str, default='/home/omnisky/diskB/datasets/SOD_Datasets/DUTS-TR')
    parser.add_argument('--train_list', type=str, default='/home/omnisky/diskB/datasets/SOD_Datasets/DUTS-TR/mypair.lst')
